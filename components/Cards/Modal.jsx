...
const Modal = ({ data, close }) => {
    ...
    return (
        <div className="ModalWrap">
            <motion.div
                className="modal flex transplate-y-1/2 transplate-x-1/2 shadow"
            ...
            >
                ...
                <motion.div className="modal__info" variants={modalInfoVariants}>
                    <motion.div className="modal__row" variants={modalRowVariants}>
                        <span className="modal__price text-3xl font-extrabold">{price}</span>
                    </motion.div>
                    <motion.div className="modal__row" variants={modalRowVariants}>
                    ...
                    >
                        <p className="modal__description text-gray-900 font-normal md:text-normal">{description}</p>
                    </motion.div>
                    <motion.button
