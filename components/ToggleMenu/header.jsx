...
export default function index() {
    ...
    return (<div className= {
        ...
        > <Link href="/">Olivier</Link> <div onClick= {
            ()=> {
        ...
        >Menu</motion.p> <motion.p variants= {
            opacity
        }
        ...
        >Close</motion.p> </div> </div> <motion.div variants= {
            opacity
        }
